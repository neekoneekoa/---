...
#define OLED_SCLK_Clr() GPIO_ResetBits(GPIOB,OLED_SCL_GPIO_Pin)//SCL
#define OLED_SCLK_Set() GPIO_SetBits(GPIOB,OLED_SCL_GPIO_Pin)

#define OLED_SDIN_Clr() GPIO_ResetBits(GPIOB,OLED_SDA_GPIO_Pin)//SDA
#define OLED_SDIN_Set() GPIO_SetBits(GPIOB,OLED_SDA_GPIO_Pin)
